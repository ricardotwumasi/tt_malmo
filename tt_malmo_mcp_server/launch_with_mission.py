"""
Launch Agent with Mission - Use pre-built Malmo missions.

This uses the tested missions from MalmoEnv/missions directory.
"""
...
""")
    ...
    mission_file = config.get_mission_path('mobchase_single_agent.xml')
    port = config.MALMO_PORT
